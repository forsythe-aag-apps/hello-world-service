...
podTemplate(label: 'mypod', containers: [
    ...
    secretVolume(mounPath: '/etc/docker/certs.d/harbor.35.192.52.128.xip.io', secretName: 'harbor-cert')
        ...
        if (!pullRequest) {
            container('docker') {
                stage('Docker build') {
                    ...
                    sh 'docker push harbor.35.192.52.128.xip.io/v2/library/hello-world-service'
                }
            }
